...
gStyle->SetOptStat(0);
    ...
    TChain dataTreem("data");
    dataTreem.Add("./MCsngl/SkimFileMass_singleMuMC2016.root");
    TChain dataTreee("data");
    dataTreee.Add("./MCsngl/SkimFileMass_singleEleMC2016.root");

    TChain dataTree2017m("data2017");
    dataTree2017m.Add("./MCsngl/SkimFileMass_singleMuMC2017.root");
    TChain dataTree2017e("data2017");
    dataTree2017e.Add("./MCsngl/SkimFileMass_singleEleMC2017.root");

    TChain dataTree2018m("data2018");
    dataTree2018m.Add("./MCsngl/SkimFileMass_singleMuMC2018.root");
    TChain dataTree2018e("data2018");
    dataTree2018e.Add("./MCsngl/SkimFileMass_singleEleMC2018.root");
 ...
 const Int_t NBINS = 7;
    ...
    TH1D*METTTBarBkgSB=new TH1D("METTTBarBkgSB", "MET [GeV]", NBINS,edges);    TH1D*METBlank=new TH1D("METBlank", "MET [GeV]", NBINS,edges);

    dataTreem.Draw("MET>>METZBkg", "(PrunedMass1>70 && PrunedMass1<100 && PrunedMass2>70 && PrunedMass2<100) ");
    dataTree2017m.Draw("MET>>METWBkg", "(PrunedMass1>70 && PrunedMass1<100 && PrunedMass2>70 && PrunedMass2<100) ");
    dataTree2018m.Draw("MET>>METTTBarBkg","( PrunedMass1>70 && PrunedMass1<100 && PrunedMass2>70 && PrunedMass2<100) ");

   dataTreem.Draw("MET>>METZBkgSB", "(((PrunedMass1>40 && PrunedMass1<70) || (PrunedMass1>100 && PrunedMass1<140)) && ((PrunedMass2>40 && PrunedMass2<70) || (PrunedMass2>100 && PrunedMass2<140))) ");
    dataTree2017m.Draw("MET>>METWBkgSB", "(((PrunedMass1>40 && PrunedMass1<70) || (PrunedMass1>100 && PrunedMass1<140)) && ((PrunedMass2>40 && PrunedMass2<70) || (PrunedMass2>100 && PrunedMass2<140))) ");
    dataTree2018m.Draw("MET>>METTTBarBkgSB","(((PrunedMass1>40 && PrunedMass1<70) || (PrunedMass1>100 && PrunedMass1<140)) && ((PrunedMass2>40 && PrunedMass2<70) || (PrunedMass2>100 && PrunedMass2<140))) ");
    ...
    METSR->Add(METWBkg);
    METSB->Add(METWBkgSB);
    cout<<"%%%%%%%"<<METSR->Integral()<<endl;
    cout<<"%%%%%%%"<<METSB->Integral()<<endl;

    TH1D*METSRe=new TH1D("METSRe", "MET [GeV]", NBINS,edges);
    TH1D*METZBkge=new TH1D("METZBkge", "MET [GeV]", NBINS,edges);
    TH1D*METWBkge=new TH1D("METWBkge", "MET [GeV]", NBINS,edges);
    TH1D*METTTBarBkge=new TH1D("METTTBarBkge", "MET [GeV]", NBINS,edges);
    TH1D*METSBe=new TH1D("METSBe", "MET [GeV]", NBINS,edges);
    TH1D*METZBkgSBe=new TH1D("METZBkgSBe", "MET [GeV]", NBINS,edges);
    TH1D*METWBkgSBe=new TH1D("METWBkgSBe", "MET [GeV]", NBINS,edges);
    TH1D*METTTBarBkgSBe=new TH1D("METTTBarBkgSBe", "MET [GeV]", NBINS,edges);    

    dataTreee.Draw("MET>>METZBkge", "(PrunedMass1>70 && PrunedMass1<100 && PrunedMass2>70 && PrunedMass2<100) ");
    dataTree2017e.Draw("MET>>METWBkge", "(PrunedMass1>70 && PrunedMass1<100 && PrunedMass2>70 && PrunedMass2<100) ");
    dataTree2018e.Draw("MET>>METTTBarBkge","( PrunedMass1>70 && PrunedMass1<100 && PrunedMass2>70 && PrunedMass2<100) ");

   dataTreee.Draw("MET>>METZBkgSBe", "(((PrunedMass1>40 && PrunedMass1<70) || (PrunedMass1>100 && PrunedMass1<140)) && ((PrunedMass2>40 && PrunedMass2<70) || (PrunedMass2>100 && PrunedMass2<140))) ");
    dataTree2017e.Draw("MET>>METWBkgSBe", "(((PrunedMass1>40 && PrunedMass1<70) || (PrunedMass1>100 && PrunedMass1<140)) && ((PrunedMass2>40 && PrunedMass2<70) || (PrunedMass2>100 && PrunedMass2<140))) ");
    dataTree2018e.Draw("MET>>METTTBarBkgSBe","(((PrunedMass1>40 && PrunedMass1<70) || (PrunedMass1>100 && PrunedMass1<140)) && ((PrunedMass2>40 && PrunedMass2<70) || (PrunedMass2>100 && PrunedMass2<140))) ");

    METSR->Add(METZBkge);
    METSB->Add(METZBkgSBe);
    METSR->Add(METTTBarBkge);
    METSB->Add(METTTBarBkgSBe);
    METSR->Add(METWBkge);
    METSB->Add(METWBkgSBe);
   ...
   // DataSLSB=(TH1D*)fin_data->Get("Sideband");
    ...
    //DataSL->Rebin(2);
       ...
       //  DataSL->Scale(1.0/DataSL->Integral());
        ...
        // DataSL->Sumw2(kFALSE);
         ...
         DataSL->DrawNormalized("ple");


         DataSLSB->DrawNormalized("PlESame");
    TLegend *leg1=new TLegend(0.32,0.75,0.87,0.84,NULL,"brNDC");
         TLegend *leg=new TLegend(0.55,0.6,0.75,0.75,NULL,"brNDC");
         leg1->AddEntry((TObject*)0, "Single-lepton validation region ", "");
        ...
        //h2->Sumw2(kFALSE);
         ...
         TGraphAsymmErrors*gr=new TGraphAsymmErrors();
           ...
           for(int i=1; i<=DataSLSB->GetNbinsX(); ++i){
                       ...
                       if(SearchRegion->GetBinError(i)<0.0000001)        h1->SetBinError(1,1.8 );
                       if(SBSearchRegion->GetBinError(i)<0.0000001)        h2->SetBinError(1,1.8 );
                       ...
                       if(h2->GetBinContent(1)>h1->GetBinContent(1)){
                           ...
                           gr->SetPoint(4, DataSLSB->GetBinCenter(i), 0);
                           gr->SetPoint(5, DataSLSB->GetBinCenter(i), 0);
                           gr->SetPoint(6, DataSLSB->GetBinCenter(i), 0);
                           gr->SetPointError(4, dx,dx,0, 0);
                           gr->SetPointError(5, dx,dx,0, 0);
         ...
         METBlank->GetYaxis()->SetRangeUser(0.001,1.2);
    ...
    gr->Draw("pesame");
        ...
        for(int i=1; i<=4; ++i){
         ...
         //leg3->SetTextFont(42);
         leg3->SetFillStyle(0);
         leg3->AddEntry(gr, "Stat. unc. in CR", "PLE");
    ...
    std::cout<<"True Fraction######## "<<DataSL->GetBinContent(i) <<std::endl;
    ...
    c1->Print("Dataonelepton.pdf");
    c1->Print("Dataonelepton.png");
