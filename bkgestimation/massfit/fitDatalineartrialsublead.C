...
void fitDatalineartrialsublead()
{
    /////////////////////////*********STANDARD SETTINGS***************/////////////////////////////////
    //////////
  ...
  OtherTree.Draw("PrunedMass2>>PrunedMassOther", "(PrunedMass1>70 && PrunedMass1<100)*Evtweight");
  SnglTTree.Draw("PrunedMass2>>PrunedMassSnglT", "( PrunedMass1>70 && PrunedMass1<100)*Evtweight");
  ZJetsTree.Draw("PrunedMass2>>PrunedMassZBkg", "( PrunedMass1>70 && PrunedMass1<100)*Evtweight");
  WJetsTree.Draw("PrunedMass2>>PrunedMassWBkg", "( PrunedMass1>70 && PrunedMass1<100)*Evtweight");
  TTBarTTree.Draw("PrunedMass2>>PrunedMassTTBarBkg","( PrunedMass1>70 && PrunedMass1<100)*Evtweight");
  QCDTree.Draw("PrunedMass2>>PrunedMassQCDBkg", "( PrunedMass1>70 && PrunedMass1<100)*Evtweight");
  T5HH1300Tree.Draw("PrunedMass2>>PrunedMassT5HH1300Sig", "(PrunedMass1>70 && PrunedMass1<100)*Evtweight");
  T5HH1700Tree.Draw("PrunedMass2>>PrunedMassT5HH1700Sig", "(PrunedMass1>70 && PrunedMass1<100)*Evtweight");
 
  dataTree->Draw("PrunedMass2>>PrunedMassdata", "((PrunedMass1>70 && PrunedMass1<100))");
  dataTree2017->Draw("PrunedMass2>>PrunedMassdata2017", "((PrunedMass1>70 && PrunedMass1<100))");
  dataTree2018->Draw("PrunedMass2>>PrunedMassdata2018","((PrunedMass1>70 && PrunedMass1<100))");
  ...
  c1->Update();
    ...
    leg1->AddEntry((TObject*)0, "Leading jet m_{jet} ", "");
  ...
  PrunedMassT5HH1700Sig->GetXaxis()->SetTitle("Subleading jet m_{jet} [GeV]");
  ...
  c1->RedrawAxis();
  c1->GetFrame()->Draw();
  c1->Print("fitDatalinearsublead.pdf",".pdf");
  c1->Print("fitDatalinearsublead.png",".png");
/*
